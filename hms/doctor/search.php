...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="assets/css/themes/theme-1.css" id="skin_color" />	<link rel="stylesheet" href="assets/css/style1.css">
	...
	<body>
		...
		<ul id="topnav">
			...
			<li id="mainav"><a class="active" href="search.php">Search</a></li>
			<li id="mainav"><a href="manage-patient.php">Manage Patients</a></li>
			<li id="mainav"><a href="add-patient.php">Add Patient</a></li>

...
<html lang="en">
	...
	<ul id="seconav">
	  ...
	  <script type="text/javascript" src="//translate.google.com/translate_a/element.js?cb=googleTranslateElementInit"></script>
		...
		<li id="secnav" style="float:right"><a href="../admin/index.php">Admin Login&nbsp&nbsp&nbsp&nbsp</a></li>
	  </ul>
	<body>
		...
		<li id="mainav"><a href="../user-login.php">Patient's Login</a></li>
			<li id="mainav"><a class="active" href="../doctor/index.php">Doctor's Login</a></li>
